...
<!----- Favicon ------>
	<link rel="icon" type="image/png" sizes="32x32" href="https://goo.gl/To7pFU">
<style>
...
<div class="cssload-preloader" style="width: 100%; height:590px; center;">
	<div class="cssload-preloader-box" > <div>E</div>		<div>I</div>		<div>D</div>		<div>M</div>		<div>U</div>		<div>B</div>		<div>A</div>		<div>R</div>		<div>A</div>		<div>K</div></div>
</div>
</center>
<!-- Sidebar Sliding Images --->
<marquee class="m1" behavior="scroll" direction="up" scrolldelay="5">  <br>
<img src="https://goo.gl/LaKMDF" height="129px" width="35px"/><br><br>
<img src="https://goo.gl/dzUAWB" height="129px" width="35px"/><br><br>
<img src="https://goo.gl/LaKMDF" height="129px" width="35px"/><br><br>
<img src="https://goo.gl/dzUAWB" height="129px" width="35px"/><br><br>
<img src="https://goo.gl/LaKMDF" height="129px" width="35px"/><br><br>
<img src="https://goo.gl/dzUAWB" height="129px" width="35px"/><br><br>
...
<audio src="https://ismailimail.files.wordpress.com/2009/09/eid-mubarak-2009-zahira-dhalwani.mp3" hidden="" controls="" autoplay="" loop=""></audio>
 <center><span style="color: #ff077a;">▁ ▂ ▄ ▅ ▆ ▇ █ WELCOME █ ▇ ▆ ▅ ▄ ▂ ▁</center>
...
<h2> <img src="https://3.bp.blogspot.com/-GmuzUILlK9Q/WxdaeGZEjPI/AAAAAAAABP0/k8HfiIq7J2QODZx75gKC_YNMYU_cLA-IACLcBGAs/s320/bb2.png" class="img-responsive" alt="Main Image" style="width: 350px; ">
</h2>
<!----- Wishing Poem Here ----->
...
<p style="text-align: center;"><strong><span style="font-size: 18pt; font-family: tahoma, arial, helvetica, sans-serif;"><span style="color: #ff0000;">》⍟☆⍣ Eid Mubarak ⍣☆⍟《</span></span></strong></p>
<img src="https://goo.gl/qxJdvf" class="img-responsive" alt="Main Image" style="width: 300px">
<img src="https://4.bp.blogspot.com/-eiRlwhyC2cE/WxdXoQA-FjI/AAAAAAAABPQ/5aArMJg4RDI0DpNaHhrndNmBRYgmkovbgCLcBGAs/s1600/bb.png" class="img-responsive" alt="Main Image" style="width: 300px">
<center>
RESPONSIVE ADS
...
var x = setInterval(function() {
  ...
  if (distance < 0) {
    clearInterval(x);
    document.getElementById("demo").innerHTML = "Id-e-Milad";
  }
}, 1000);
</script>        
</div>
...
<center> <p style="text-align: center;"><span style="background-color: #663399; color: #FFFAFA; font-size: 15pt; font-family: tahoma, arial, helvetica, sans-serif;">&nbsp; yah msg sab k mobile mein hona chaahie yah aapaka kam hy so share </span></p>
LINK ADS
...
<!-- This Script is from www.htmlfreecodes.com, Provided by: Ripon sahaji -->
